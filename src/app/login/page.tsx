    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900">maketica</h1>
          <p className="text-sm text-gray-500 mt-1">CPA 제휴마케팅 플랫폼</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            <svg className="w-5 h-5 shrink-0" viewBox="0 0 24 24" fill="#191919">
              <path d="M12 3C6.48 3 2 6.48 2 10.8c0 2.73 1.65 5.13 4.13 6.55L5.1 21l4.87-2.55c.65.09 1.33.15 2.03.15 5.52 0 10-3.48 10-7.8S17.52 3 12 3z"/>
            </svg>
            카카오로 로그인
          </button>
