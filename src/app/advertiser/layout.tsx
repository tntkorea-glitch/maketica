...
const navItems = [
  { href: "/advertiser", label: "대시보드", icon: "📊" },
  { href: "/advertiser/campaigns", label: "캠페인 관리", icon: "📋" },
  { href: "/advertiser/campaigns/new", label: "캠페인 등록", icon: "➕" },
  { href: "/advertiser/conversions", label: "전환 리포트", icon: "📈" },
  { href: "/advertiser/charge", label: "예치금 충전", icon: "💳" },
];
...
export default async function AdvertiserLayout({ children }: { children: React.ReactNode }) {
  ...
  if (role !== "ADVERTISER" && role !== "ADMIN") redirect("/dashboard");
    ...
    <div className="min-h-screen bg-gray-50 flex">
      <aside className="w-56 bg-white border-r border-gray-100 flex flex-col shrink-0">
        <div className="px-5 py-6 border-b border-gray-100">
          ...
          <p className="text-xs text-gray-400 mt-0.5">광고주 센터</p>
        </div>
